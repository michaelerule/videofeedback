 ...
 * 
 */
public class BlurSharpen555 {

    private final DoubleBuffer555 buffer;
    private final int[] temp;
    
    public BlurSharpen555(DoubleBuffer555 b) {
        buffer = b;
    ...
    private void horizontalBlur12() {
        ...
        for (int y=0; y<H; y++) {
            ...
            int p = data[N0++] & MASK12;
            int c = data[N0++] & MASK12;
            int n = data[N0++] & MASK12;
    ...
    private void blur12(int A) {
        ...
        for (int x=0; x<W; x++) {
            ...
            for (int y=1; y<H2; y++) {
                // Obtain the next pixel and shift forward
                b[k] = blend(b[k], p*Q1+c*Q2+n*Q3+R>>S, A);
                p = c; 
                c = n;
                n = temp[N0++] & MASK12;
                k+= W;
    ...
    private void sharp12(int A) {
        ...
        for (int x=0; x<W; x++) {
            ...
            for (int i=1; i<H2; i++) {
                ...
                d[k] = unsharp(d[k], p*Q1+c*Q2+n*Q3+R>>S, A);
                // Obtain the next pixel and shift forward
                p = c; 
                c = n;
                n = temp[N0++] & MASK12;
