...
public class ColorUtil {
     ...
     * @param c2
     * @return  */
    public static int mean(int c1, int c2) {
     ...
     * @param w
     * @return  */
    public static int blend(int q, int p, int w) {
        /*
     ...
     * @return
     */
    public static synchronized int rotateHue(int RGB, float d) {/*
        int HSV = RGBtoHSV(RGB);
    ...
    public static void colorFilter(
            DataBuffer b, int start, int stop, float hr, float sr, float lr, float cr, float br) {
        float 
     ...
     */
    public static void colorFilter(
            int [] b, int start, int stop, float hr, float sr, float lr, float cr, float br) {
        float 
            gamma= br<=.5? cr*br*2   : 2*cr*(1-br),
            beta = br<=.5? br*(1-cr) : br-cr+br*cr;
        beta *= 255;
