...
public class FastMath {
     ...
     * @since 3.4
     */
    public static int toIntExact(final long n) throws ArithmeticException {
     ...
     * @since 3.4
     */
    public static int incrementExact(final int n) throws ArithmeticException {

        if (n == Integer.MAX_VALUE) {
            throw new ArithmeticException("OVERFLOW_IN_ADDITION");
        }
     ...
     * @since 3.4
     */
    public static long incrementExact(final long n) throws ArithmeticException {
     ...
     * @since 3.4
     */
    public static int decrementExact(final int n) throws ArithmeticException {

        if (n == Integer.MIN_VALUE) {
            throw new ArithmeticException("OVERFLOW_IN_SUBTRACTION");
        }
     ...
     * @since 3.4
     */
    public static long decrementExact(final long n) throws ArithmeticException {
    ...
    public static int multiplyExact(final int a, final int b) {
        if (((b  >  0)  && (a > Integer.MAX_VALUE / b || a < Integer.MIN_VALUE / b)) ||
            ...
            throw new ArithmeticException("OVERFLOW_IN_MULTIPLICATION");
        }
        return a * b;
    }
     ...
     * @since 3.4
     */
    public static int floorDiv(final int a, final int b) throws ArithmeticException {

        if (b == 0) {
            throw new ArithmeticException("ZERO_DENOMINATOR");
        }
     ...
     * @since 3.4
     */
    public static long floorDiv(final long a, final long b) throws ArithmeticException {
     ...
     * @since 3.4
     */
    public static int floorMod(final int a, final int b) throws ArithmeticException {
