 ...
 * MathTokens in a user inputted equations. An instance of this class contains 
 * a MathToken and a reference to a left and right sub equation.
 * <p>
...
{    
    ...
    private Evaluation myEvaluationOperation;
    ...
    public String getVariables()
    {
        ...
        if (right == null)
        {
            if (left == null)
            {
                if (myEvaluationOperation.equals(Evaluation.VARIABLE)) result += myEvaluationOperation;
            }
    ...
    public String toString()
    {
        ...
        try
        {
            if (myEvaluationOperation.equals(Evaluation.FUNCTION))
            {
