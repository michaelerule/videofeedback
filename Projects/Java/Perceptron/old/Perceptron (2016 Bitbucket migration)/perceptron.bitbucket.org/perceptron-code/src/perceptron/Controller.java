...
public final class Controller implements AbstractController {
    ...
    public void addControl(String name, double min, double max, double init, double r) {
        ...
        try {
            rc = new RadialControl(min, max, init, R, object.getClass().getMethod(setterName(name), Double.TYPE), name);
        } catch (Exception e1) {
            try {
                rc = new RadialControl(min, max, init, R, object.getClass().getMethod(setterName(name), Float.TYPE), name);
            } catch (Exception e2) {
                try {
                    rc = new RadialControl(min, max, init, R, object.getClass().getMethod(setterName(name), Integer.TYPE), name);
                } catch (Exception e3) {
                }
            }
        }
    ...
    public final class RadialControl {
        ...
        public RadialControl(double min, double max, double v, int r, Method M, String name) {
            this.radius = r;
