...
public class Tree3D11 {
    ...
    /**
     * Array and data_buffer for the Color indecies
     */
     ...
     */
    public Tree3D11(int min_tree_depth, int max_tree_depth, short[][] tree_root, int tree_color, TreeForm[] tree_form, java.awt.Point tree_location,
                    DoubleBuffer b) {
        buffer = b;
        ...
        // Initialize arrays to store the point location of branches as short
        // three vectors
    ...
    public void render() {
        ...
        output_Graphics.drawLine(location.x + branch[0][0], location.y + branch[0][1], location.x + branch[1][0], location.y + branch[1][1]);
        output_Graphics.drawLine(location.x - branch[0][0], location.y - branch[0][1], location.x - branch[1][0], location.y - branch[1][1]);
        ...
        int child_index, writing_index, x, y;
        ...
        for (int n = 1; n < SPLIT; n++) {
            ...
            if (radius[parent_index] > RADIUS_CUTOFF) {
                ...
                if (radius[child_index] > RADIUS_CUTOFF) {
                    ...
                    output_Graphics.drawLine(x, y, location.x + branch[child_index][0], location.y + branch[child_index][1]);
                }
                child_index++;
                if (radius[child_index] > RADIUS_CUTOFF) {
