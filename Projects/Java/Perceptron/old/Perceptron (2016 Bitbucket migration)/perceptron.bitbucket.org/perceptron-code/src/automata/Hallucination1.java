    ...
    public void step() {
        ...
        for (int y = 0; y < gridsize; y++) {
            for (int x = 0; x < gridsize; x++) {
                ...
                data.setElem(i, ColorUtility.average(ColorUtility.average(color1, color, color2, 0xff & ~color), 24, data.getElem(i), 232));
                // data.setElem(i,
                // ColorUtility.average(color1,color,color2,0xff&~color));
                i++;
            }
        }
        int[] temp = cortex;
