...
public class Moths {
    ...
    class Moth extends Point2D.Float {
        ...
        private static final long serialVersionUID = 2576405211007886994L;
        float vx;
        float vy;
        float px;
        float py;
    ...
    final class Light extends Point2D.Float {

        private static final long serialVersionUID = 3458420281851173762L;
        float intensity;
    ...
    static BufferedImage grabImage() {
        try {
            ...
            System.err.println("could not open image moth.png");
        }
        return null;
    }
