...
public class ScreenRecorder extends AbstractStateModel {
    ...
    /**
     * Creates a screen recorder for use with Perceptron.
     *
     */
    public ScreenRecorder(Perceptron P,
    ...
    /**
     * Starts screen capture for use with Perceptron.
     */
    private void startScreenCapture() throws AWTException, IOException {
        ...
        screenGrabber = new ScreenGrabber(perceptron, this, recordingStartTime);
    ...
    private static class ScreenGrabber implements Runnable {
        ...
        /**
         * The AWT Robot which we use for capturing the screen. Unused for Perceptron.
         */
        private Robot robot;
        private Rectangle captureArea;
        /**
        ...
        public ScreenGrabber(Perceptron P, ScreenRecorder recorder, long startTime) throws AWTException, IOException {
            perceptron = P;
        ...
        public void run() {
            try {
                if (ScreenRecorderMain.perceptron_mode) {
                    grabPerceptronScreen();
                } else {
                    grabScreen();
                }
            } catch (Throwable ex) {
        ...
        /** Grab the Perceptron's screen. */
        private void grabPerceptronScreen() throws IOException, InterruptedException {
            // Capture the screen
            BufferedImage previousScreenCapture = screenCapture;
            long timeBeforeCapture = System.currentTimeMillis();
            try {
                screenCapture = perceptron.buffered_image;
