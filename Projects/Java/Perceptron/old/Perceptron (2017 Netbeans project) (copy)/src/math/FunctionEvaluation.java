...
<p>
yeah.
<p> FunctionEvaluation.java
<p> ResFracti
<p> Created by Michael Rule on Mon Apr 04 2005.
<p> Copyright (c) 2005 __MyCompanyName__. All rights reserved.
*/

public class FunctionEvaluation implements Evaluation {
	...
	private int myOperation;
         ...
         * @param left
         */
        public FunctionEvaluation(MathToken opr,Evaluation left) {
		this.left = left;
