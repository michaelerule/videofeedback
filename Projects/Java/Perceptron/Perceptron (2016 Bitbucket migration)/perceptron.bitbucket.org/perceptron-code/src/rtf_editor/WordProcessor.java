...
/**
 * Adapted from http://www.javafaq.nu/java-bookpage-31-1.html for use with Perceptron.
 */
...
public class WordProcessor extends JFrame {
    ...
    File default_help_file = new File("log.rtf");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Thread runner = new Thread() {
                    public void run() {
                        ...
                        if (file.exists()) {
                            Short_filename name = new Short_filename(file_chooser.getSelectedFile().getName());
