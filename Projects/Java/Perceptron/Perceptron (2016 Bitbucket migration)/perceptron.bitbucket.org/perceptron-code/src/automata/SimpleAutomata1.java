...
public class SimpleAutomata1 {
    ...
    void check_init() {
        ...
        /**
         * System.out.println( "dt = " + tofloat(dt) ); System.out.println( "c1
         * = " + tofloat(c1) ); System.out.println( "amp = " + tofloat( amp ) );
         * System.out.println( "w = " + tofloat( w ) ); System.out.println( "thr
         * = " + tofloat( thr ) ); System.out.println( "c = " + tofloat( c ) );
         * System.out.println( "tau = " + tofloat( tau ) ); System.out.println(
         * "b = " + tofloat( b ) ); System.out.println( "a = " + tofloat( a ) );
         * System.out.println( "g = " + tofloat( g ) ); System.out.println( "te
         * = " + tofloat( te ) ); System.out.println( "an = " + tofloat( an ) );
         */
    }
    ...
    float tofloat(int i) {
        return i * demultiplier;
    }

    /*
     * int iheav( double x ) { return x < 0 ? 0 : x == 0 ? 128 : 256 ; }
     * 
     * int inoise() { return toint(tofloat(amp)*(float)rand.nextGaussian()) ; }
     */
    float f(float x) {
        if (x < -4) {
            return 0;
        ...
        return .5f + x * .25f + x * x * x * -0.0625f / 6 + x * x * x * x * x * 0.0104166667f / 120 + x * x * x * x * x * x * x * -0.00147569444f / 5040;
    ...
    public void step() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 0; j < size; j++) {
                ...
                ubuff[i][j] = mul(ic1, u[i][j]) + toint(dt * f(tofloat(ika) - g * v[i][j] + const1 + an * noise()));
