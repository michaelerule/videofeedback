 ...
 * values between 0 and 1, for correct behavior when transitioning. The size of
 * the data array must be a power of two ut support modulo by bitmasking. the
 * ColorScheme determines how the automata values are mapped to colors.
...
import static util.ColorUtility.average;
