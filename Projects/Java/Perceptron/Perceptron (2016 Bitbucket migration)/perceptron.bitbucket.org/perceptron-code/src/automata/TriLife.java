...
public class TriLife extends JPanel {

    private static final long serialVersionUID = 3085620942582008673L;
    ...
    static final int[][] neighborhood = {{-1, 1, 2}, {0, 1, 1}, {1, 1, 2}, {-2, 0, 2}, {-1, 0, 3}, {1, 0, 3}, {2, 0, 2}, {-2, -1, 1},
            {-1, -1, 2}, {0, -1, 3}, {1, -1, 2}, {2, -1, 1}};
    ...
    public void scan() {
        DoubleBuffer.ImageRenderContext[] image = {perceptron.double_buffer.output, perceptron.double_buffer.image_fade};
        if (image[1] == null || image[0] == null) {
            ...
            for (int y = 0; y < imageH; y++) {
                for (int x = 0; x < imageW; x++) {
                    sketch_buffer.setElem(i, image[grid[lookup[i]] & 1].getColor(x << 8, y << 8));
                    i++;
                }
            }
        }
