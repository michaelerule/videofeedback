 ...
 * @author mer49
 */
public class BufferedImageInt555 {
    ...
    public static final int
            ...
            MASK  = UNIT -  1,  // 31
            ROUND = MASK >> 1,  // 16
            R = 0b0000001111100000000000000000000,
            G = 0b0000000000000000111110000000000,
            B = 0b0000000000000000000000000011111,
            M = 0b0000001111100000111110000011111,
            O = 0b0000000000100000000010000000001,
            ε = O*ROUND;
     ...
     * @return 
     */
    public static final int blend(int c1, int c2, int w) {
        return M & (c2 + ( (c1-c2)*w + ε >> SHIFT ));
    }
     ...
     * @return 
     */
    public static final int lirp(int c00, int c01, int c10, int c11, int wx, int wy) {
        int ux = UNIT - wx;
        int uy = UNIT - wy;
        ...
        return M&(c11+((c00-c11)*p+(c01-c11)*q+(c10-c11)*r+ε>>SHIFT));
    }
     ...
     */
    public static final int to888(int c) {
        c |= c<<5;
     ...
     */
    public static final int from888(int c) {
        return 
     ...
     * @return 050505 -R-G-B packed color
     */
    public static final int toShort555(int c) {
        return 
     ...
     * @return 
     */
    public static final int fromShort555(int c) {
        return 
            ((0b111110000000000&c)<<10)|
            ((0b000001111100000&c)<<5)|
            ((0b000000000011111&c));
    ...
    public BufferedImageInt555(int W, int H) {
    ...
    public void freeze() {
        if (frozen) return;
        for (int i=0; i<length; i++) buf.setElem(i,toShort555(data[i]));
        frozen = true;
    }
    public void thaw() {
        if (!frozen) return;
        for (int i=0; i<length; i++) data[i] = fromShort555(buf.getElem(i));
        frozen = false;
    }
     ...
     */
    public void blend(BufferedImageInt555 other, byte [] alpha) {
     ...
     */
    public void blend(int color, int alpha) {
    ...
    public static void main(String [] args) {
        ...
        BufferedImageInt555 img = new BufferedImageInt555(w,h);
