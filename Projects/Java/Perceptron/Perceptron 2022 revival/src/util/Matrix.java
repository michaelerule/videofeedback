...
public class Matrix {
     ...
     *  of A,B but assumes that they are of the correct
     *  dimensions for calculation of the matrix product
     *  AB.The result is stored in the given result array.A is M x N matrix B is N x P matrix
     * @param A
     * @param B
     * @param result
     * @return
     ...
     *  K1 and K2 basis vectors for angle alpha in radians.K1 < K2, K1, K2 elements of [0 N-1]
  N a natural number
     * @param N
     * @param K1
     * @param K2
